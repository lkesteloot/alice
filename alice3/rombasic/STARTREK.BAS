...
205 WIDTH 80
210 PRINT CHR$(26)
218 FOR XX=1 TO 6:PRINT:NEXT
219 PRINT TAB(20);"THE USS ENTERPRISE --- NCC-1701":PRINT
220 FOR YY=1 TO 40 STEP 2
221 PRINT TAB(YY);"                  ,------*------,"
222 PRINT TAB(YY);"  ,-------------   '---  ------'"
223 PRINT TAB(YY);"   '-------- --'      / /"
224 PRINT TAB(YY);"       ,---' '-------/ /--,"
...
1260 PRINT"   ON STARDATE";T0+T9;CHR$(8);". THIS GIVES YOU";
1261 PRINT T9;"DAYS. THERE";X0$
1270 PRINT"  ";B9;"STARBASE";X$;" IN THE GALAXY FOR RESUPPLYING YOUR ";
1271 PRINT"   SHIP.":PRINT
1281 PRINT "ARE YOU READY TO ACCEPT COMMAND ('N' FOR INSTRUCTIONS)";
1300 INPUT I5$:I5$=LEFT$(I5$,1)
1302 IF I5$="N" OR I5$="n" THEN PRINT "RUN TREKINST"
1305 IF I5$="Y" OR I5$="y" THEN 1310
1307 GOTO 1280
1310 PRINT CHR$(26)
...
1560 PRINT TAB(3);CHR$(22);"  COMBAT AREA      CONDITION RED  ";
1565 PRINT CHR$(22):IF S>200 THEN PRINT:GOTO 1590
1580 PRINT TAB(3);CHR$(22);"      SHIELDS DANGEROUSLY LOW     ";
1585 PRINT CHR$(22):PRINT
...
2365 IF D(1)<0 AND W1>.2 THEN 2470
...
3175 IF S1<1 OR S1>=9 OR S2<1 OR S2>=9 THEN 3500
...
3840 PRINT"  AT SECTOR";S1;CHR$(8);",";S2;"OF QUADRANT";Q1;CHR$(8);
3845 PRINT ",";Q2;CHR$(8);".'"
...
4185 IF N(L)<0 THEN PRINT"*** ";:GOTO 4230
...
4505 PRINT K(I,2);CHR$(8);".":GOTO 4670
4530 K(I,3)=K(I,3)-H:PRINT H;"UNIT HIT ON KLINGON AT SECTOR";K(I,1);
4531 PRINT CHR$(8);",";
4550 PRINT K(I,2);CHR$(8);"."
4551 IF K(I,3)<=0 THEN 4560
4555 PRINT CHR$(22);"*** KLINGON DESTROYED ***";CHR$(22):PRINT
4556 GOTO 4580
...
5115 PRINT:K3=K3-1:K9=K9-1:IF K9<=0 THEN 6370
...
5330 PRINT CHR$(22);"*** STARBASE DESTROYED ***";CHR$(22):B3=B3-1
5335 B9=B9-1
...
6360 PRINT:PRINT "BACK TO SYSTEM.":STOP
...
6775 FOR I=1 TO 8:PRINT I;"|";
6820 FOR J=(I-1)*24+1 TO(I-1)*24+22 STEP 3:PRINT" ";MID$(Q$,J,3);
6825 NEXT J:PRINT"|";I;
6830 ON I GOTO 6850,6900,6960,7020,7070,7120,7180,7240
6850 PRINT"        STARDATE          ";
6855 PRINT INT(T*10)*.1:GOTO 7260
6900 PRINT"        CONDITION          ";
6905 IF C$="*RED*" THEN PRINT CHR$(22);C$;CHR$(22):GOTO 7260
6907 IF C$="DOCKED" THEN PRINT CHR$(22);C$;CHR$(22):GOTO 7260
6910 PRINT C$:GOTO 7260
...
8160 PRINT"YOU ARE AT QUADRANT ";Q1;CHR$(8);",";Q2;" SECTOR ";S1;
8161 PRINT CHR$(8);",";S2;CHR$(8);"."
...
8500 IF B3<>0 THEN PRINT"FROM ENTERPRISE TO STARBASE:":W1=B4
8505 IF B3<>0 THEN X=B5:GOTO 8120
